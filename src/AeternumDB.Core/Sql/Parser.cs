...
using AeternumDB.Core.Sql.Tokenizer;
using SqlTokenizer = AeternumDB.Core.Sql.Tokenizer.Tokenizer;

namespace AeternumDB.Core.Sql;

/// <summary>
/// Manual recursive-descent parser for the SQL subset needed by AeternumDB.
/// Transpiled from poc/rust/src/sql/parser.rs. AOT-compatible — no reflection.
/// </summary>
