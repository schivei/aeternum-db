...
//
// Transpiled from poc/rust/src/sql/ast.rs.
// Discriminated unions use the abstract-base + sealed-subclass pattern for AOT compatibility.
...
/// <summary>
/// Errors that can occur while parsing or lowering an AST node.
/// </summary>
public sealed class AstException : Exception
{
    public AstErrorKind Kind { get; }
    public AstException(AstErrorKind kind, string message) : base(message) { Kind = kind; }
}

public enum AstErrorKind
{
    Unsupported,
    Invalid,
}
...
public enum BinaryOperator
{
    ...
    // Regular expression
    Regexp, NotRegexp,
    RegexpMatch, RegexpIMatch, NotRegexpMatch, NotRegexpIMatch,
    // Bitwise
    BitwiseAnd, BitwiseOr, BitwiseXor,
    ShiftLeft, ShiftRight,
    // String concatenation
    StringConcat,
    // Reverse pattern matching (AeternumDB extension)
    RevLike, NotRevLike, RevILike, NotRevILike,
    RevRegexp, NotRevRegexp, RevRegexpIMatch, NotRevRegexpIMatch,
}
...
{
    Cascade, SetNull, SetDefault, Restrict, NoAction,
}

public enum OnCommitBehavior
{
    PreserveRows, DeleteRows, Drop,
}
